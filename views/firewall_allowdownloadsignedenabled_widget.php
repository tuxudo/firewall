<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="firewall_allowdownloadsignedenabled-widget">
        <div id="firewall_allowdownloadsignedenabled-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-certificate"></i> 
                <span data-i18n="firewall.allowdownloadsignedenabled"></span>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/firewall/get_allowdownloadsignedenabled', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#firewall_allowdownloadsignedenabled-widget div.panel-body'),
